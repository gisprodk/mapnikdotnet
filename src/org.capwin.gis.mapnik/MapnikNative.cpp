...
#include "StdAfx.h"
#include "MapnikNative.h"


MapnikNative::MapnikNative(void)
{
}
...
void MapnikNative::InitializeXMLMap(CString appDirectory, CString xmlMapFile, int width, int height) {
	...
	void MapnikNative::RenderToFile(std::string fileName, std::string type, int width, int height,  double lat1,  double long1,  double lat2,  double long2) {
